// --- LOGIC MỞ QUÀ & PHÁT NHẠC (FIX LỖI IPHONE) ---
...
// Xử lý sự kiện khi bấm nút "Mở quà ngay"
  ...
  if (btnOpen && overlay) {
    btnOpen.addEventListener("click", function () {
      ...
      setTimeout(function () {
        ...
        // 3. Bắt đầu chạy hiệu ứng
        confetti();
        _slideSatu();
      }, 1000);
    });
  } else {
    // Fallback: Nếu quên thêm nút mở quà thì chạy luôn
    playMusic();
    confetti();
    _slideSatu();
  }
...
const _slideSatu = function () {
  ...
  // Hiện text "Chạm để tiếp tục" sau 3 giây
  setTimeout(function () {
...
const _slideDua = function () {
  ...
  // Hiệu ứng chuyển cảnh từ Slide 1 -> Slide 2
  setTimeout(function () {
  ...
  // Chờ đọc xong lời chúc (khoảng 15s) mới cho bấm tiếp
  setTimeout(function () {
    tap.classList.remove("d-none");
    document.body.addEventListener("click", function () {
      ...
      setTimeout(function () {
        slideDua.remove();
        // SỬA: Bỏ qua câu hỏi, nhảy thẳng đến kết thúc (Trái tim)
        _slideLima();
      }, 1000);
    });
  }, 15000);
...
// Đã xóa function _slideEmpat (Câu hỏi Có/Không)
...
// --- NỘI DUNG LỜI CHÚC (TIẾNG VIỆT) ---

new TypeIt("#teks1", {
  strings: [
    "Chúc mừng sinh nhật con mắm thanh dy",
    "Tuổi mới ăn mau chóng lớn",
    "Trăm năm hạnh phúc",
    "Học giỏi",
    "Sống lâu trăm tuổi",
  ],
